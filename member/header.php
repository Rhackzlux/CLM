...
<body class="index-body">
	...
	<div style="background-color:#43133c;"lass="container-fluid">
	
	<div style = "background-color:#43133c;"class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="../bg-images/cocs.png" alt="Logo" style="width: 30px; height: 30px; vertical-align: middle; margin-right: 8px;"> Computer Laboratory Reservation</a>
				<ul class="user-menu">
