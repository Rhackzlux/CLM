...
<div class="right-sidebar equipment-side">
    ...
    <div class="form-group">
        ...
        <input type="text" name="e_number" class="form-control" placeholder= "Device ID " required>
    </div>
    <div class="form-group">
        <label>Model</label>
        <input type="text" name="e_model" class="form-control"  placeholder= "Model " required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label>Name</label>
        <input type="text" name="e_brand" class="form-control" placeholder= "Equipment Name " required>
    </div>
    <div class="form-group">
