...
<body>
	<table style="width:100%" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
				<td><img src="cocs1.png" class="img-responsive" /></td>
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">COLLEGE OF COMPUTER SCIENCE</p>
					<p style="margin:0;padding:0;font-weight:bold;">COMPUTER LABORATORY</p>
					<p style="margin:0;padding:0;"></p>
				</td>
				<td><img src="cocs1.png" class="img-responsive" style="visibility: hidden" /></td>
			</tr>
			<tr>
				<td></td>
				<td style="text-align:center; font-weight:bold; padding:30px 0; font-size:18pt; font-family:'Bookman Old Style'; text-transform: uppercase;">Proof Receipt</td>
				<td></td>
			</tr>
			<tr>
					...
					<table style="width:100%; border:1px solid #000; border-bottom: none;" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								...
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000; border-left:1px solid #000;">Equipment Name</th>
