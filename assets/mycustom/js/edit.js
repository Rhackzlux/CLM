	...
	var id = getequipmentid();
     ...
     var append = '<form class="frm_edititem">\
						...
						<div class="form-group">\
							...
							<div class="form-group">\
							<label>Status</label>\
							<select type="text" name="e_status" class="form-control" required>\
								<option selected>'+e_status+'</option>\
								<option>Old</option>\
								<option>New</option>\
								</select>\
								</div>\
...
table_user.on('click', 'a.edit-upass', function(e){
	...
	var form = '<form class="changepass">\
				...
				<div class="form-group">\
					...
					<input type="password" name="c_pass" class="form-control" value="'+tr[5]+'" required="required">\
				</div>\
				<div class="form-group">\
